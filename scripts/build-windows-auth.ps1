...
& cl.exe /nologo /std:c++20 /EHsc /O2 /guard:cf native/windows-auth.cpp /Fe:resources/native/voyager-auth.exe /Fo:resources/native/voyager-auth.obj /link windowsapp.lib /DYNAMICBASE /NXCOMPAT /CETCOMPAT
